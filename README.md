# Better Section Word Count

This plugin is the same as the **Better Word Count** plugin, except that it can count the current section words, characters, etc.
本插件基于Better Word Count增加了章节统计。



BWC's README is as follow.
